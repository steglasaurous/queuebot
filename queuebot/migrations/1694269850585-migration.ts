...
export class Migration1694269850585 implements MigrationInterface {
  name = 'Migration1694269850585';
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      "INSERT INTO game (name, displayName, twitchCategoryId) VALUES ('audio_trip', 'Audio Trip', '514866')",
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('DELETE FROM song WHERE gameId = 1');
