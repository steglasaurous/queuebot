...
export class Migration1694279063189 implements MigrationInterface {
    name = 'Migration1694279063189'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "channel" ("channelName" varchar PRIMARY KEY NOT NULL, "joinedOn" datetime NOT NULL, "lang" varchar NOT NULL DEFAULT ('en'), "gameId" integer, CONSTRAINT "FK_d87d7370a6433219a9b73982070" FOREIGN KEY ("gameId") REFERENCES "game" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
